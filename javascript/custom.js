require(["jquery"], function ($) {
  ...
  $(document).ready(function() {
    $('.contact-tabs_button').on('click', function() {
        // Obtener el índice del botón de pestaña clickeado
        var tabIndex = $(this).index();

        // Ocultar todos los contenidos de las pestañas
        $('.contact-tabs_content').removeClass('active').hide();

        // Mostrar el contenido de la pestaña correspondiente al botón clickeado
        $('.contact-tabs_content').eq(tabIndex).addClass('active').show();

        // Remover la clase 'active' de todos los botones de pestaña
        $('.contact-tabs_button').removeClass('active');

        // Agregar la clase 'active' al botón de pestaña clickeado
